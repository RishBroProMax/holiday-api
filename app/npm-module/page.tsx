          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            <Link href="/" className="flex items-center gap-3 group">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="hidden sm:inline-block px-2 py-0.5 rounded-full text-[10px] font-mono font-semibold bg-emerald-400/10 text-emerald-400 border border-emerald-400/30">
                  NPM v3.0
                </span>
              </div>
            </Link>
            ...
            <nav className="hidden lg:flex items-center gap-5 text-xs font-semibold tracking-wide">
              ...
              <Link href="/npm-module" className="text-emerald-400 font-bold flex items-center gap-1.5 border-b-2 border-emerald-400 pb-0.5">
